...
var MegadraftEditor = ((_temp = _class = (function(_Component) {
  ...
  function MegadraftEditor(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (
        MegadraftEditor.__proto__ || Object.getPrototypeOf(MegadraftEditor)
      ).call(this, props)
    );
    ...
    _this.blocksWithoutStyleReset =
      _this.props.blocksWithoutStyleReset || NO_RESET_STYLE_DEFAULT;
    ...
    _this.extendedBlockRenderMap = _draftJs2.default.DefaultDraftBlockRenderMap.merge(
      blockRenderMap
    );
    return _this;
  }
  ...
  _createClass(MegadraftEditor, [
    {
      ...
      value: function getValidPlugins() {
        ...
        try {
          for (
            var _iterator = (this.props.plugins || _default2.default)[
                Symbol.iterator
              ](),
              _step;
    ...
    },
    {
      ...
      value: function externalKeyBindings(e) {
        ...
        try {
          for (
            var _iterator3 = this.keyBindings[Symbol.iterator](), _step3;
    ...
    {
      key: "resetBlockStyle",
      value: function resetBlockStyle(
        editorState,
        selection,
        contentState,
        currentBlock,
        ...
        var resetState = _draftJs.EditorState.push(
          editorState,
          newContentState,
          "split-block"
        );
        var emptySelection = _draftJs.SelectionState.createEmpty(emptyBlockKey);
        var editorSelected = _draftJs.EditorState.forceSelection(
          resetState,
          emptySelection
        );
        var noStyleState = _draftJs.EditorState.setInlineStyleOverride(
          editorSelected,
          noStyle
        );
    ...
    },
    {
      ...
      value: function handleReturn(event) {
        ...
        if (!event.shiftKey) {
          ...
          var noReset = this.blocksWithoutStyleReset.includes(
            currentBlock.type
          );
        ...
        var contentBlock = currentContent
          .getBlockMap()
    ...
    },
    {
      ...
      value: function mediaBlockRenderer(block) {
        ...
        var plugin =
          this.pluginsByType[type] || this.handleBlockNotFound(block);
        if (!plugin) {
          return null;
        }
    ...
    },
    {
      ...
      value: function renderToolbar(props) {
        var _props$Toolbar = this.props.Toolbar,
          Toolbar =
            _props$Toolbar === undefined ? _Toolbar2.default : _props$Toolbar;
