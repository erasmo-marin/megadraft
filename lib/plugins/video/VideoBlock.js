...
var VideoBlock = function (_Component) {
  ...
  _createClass(VideoBlock, [{
    ...
    key: "_getYoutubeId",
    value: function _getYoutubeId(url) {
    ...
    key: "renderYoutubeElement",
    value: function renderYoutubeElement(url) {
      var videoId = this._getYoutubeId(url);

      return _react2.default.createElement(
        "div",
        { className: "block__content__videoContainer" },
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          null,
          this.isYoutubeUrl(this.props.data.src) ? this.renderYoutubeElement(this.props.data.src) : _react2.default.createElement("video", { controls: true, style: _VideoBlockStyle2.default.video, src: this.props.data.src, alt: "" })
        ),
        _react2.default.createElement(
          _plugin.BlockData,
          null,
