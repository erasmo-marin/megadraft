...
var BlockStyles = (function(_Component) {
  ...
  function BlockStyles(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (BlockStyles.__proto__ || Object.getPrototypeOf(BlockStyles)).call(
        this,
        props
      )
    );
  ...
  _createClass(BlockStyles, [
    ...
    },
    {
      ...
      value: function render() {
        var maxSidebarButtons = this.props.maxSidebarButtons
          ? this.props.maxSidebarButtons
          : this.props.plugins.length;

        var width = this.props.open ? (maxSidebarButtons + 1) * 25 : 0;
...
var ToggleButton = (exports.ToggleButton = (function(_Component2) {
  ...
  function ToggleButton() {
    ...
    return _possibleConstructorReturn(
      this,
      (ToggleButton.__proto__ || Object.getPrototypeOf(ToggleButton)).apply(
        this,
        arguments
      )
    );
  ...
  _createClass(ToggleButton, [
    {
      ...
      value: function render() {
        ...
        var className = (0, _classnames2.default)("sidemenu__button__menu", {
...
var SideBar = (function(_Component4) {
  ...
  function SideBar(props) {
    ...
    var _this5 = _possibleConstructorReturn(
      this,
      (SideBar.__proto__ || Object.getPrototypeOf(SideBar)).call(this, props)
    );
  ...
  _createClass(SideBar, [
    {
      ...
      value: function getValidSidebarPlugins() {
        ...
        try {
          for (
            var _iterator = this.props.plugins[Symbol.iterator](), _step;
    ...
    },
    {
      ...
      value: function setBarPosition() {
        ...
        var element = (0, _utils.getSelectedBlockElement)(
