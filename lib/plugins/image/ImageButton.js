...
var BlockButton = (function(_Component) {
  ...
  function BlockButton(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (BlockButton.__proto__ || Object.getPrototypeOf(BlockButton)).call(
        this,
        props
      )
    );
  ...
  _createClass(BlockButton, [
    {
      ...
      value: function onClick(e) {
        ...
        this.props.onChange(
          (0, _insertDataBlock2.default)(this.props.editorState, data)
        );
      }
    },
    {
      ...
      value: function render() {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(_icons2.default.ImageIcon, {
