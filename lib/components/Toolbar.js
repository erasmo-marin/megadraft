...
var Toolbar = (_temp = _class = function (_Component) {
  ...
  _createClass(Toolbar, [{
    ...
    value: function setBarPosition() {
      ...
      var left = selectionCoords.offsetLeft;
      if (selectionCoords.offsetLeft < toolbar.offsetWidth / 2) left = toolbar.offsetWidth / 2;

      if (selectionCoords && !this.state.position || this.state.position.bottom !== selectionCoords.offsetBottom || this.state.position.left !== left || !this.state.show) {
        this.setState({
          show: true,
          position: {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        "div",
        { className: toolbarClass, style: this.state.position },
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement("span", { className: "toolbar__arrow", style: { display: "none" }, ref: function ref(el) {
                _this4.arrowEl = el;
              } })
          )
        )
