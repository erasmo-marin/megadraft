...
var Media = (function(_Component) {
  ...
  function Media(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (Media.__proto__ || Object.getPrototypeOf(Media)).call(this, props)
    );
  ...
  _createClass(Media, [
    {
      ...
      value: function remove() {
        ...
        var newState = _draftJs.EditorState.push(
          editorState,
          withoutAtomicBlock,
          "remove-range"
        );
        ...
        if (keyAfter) {
          ...
          var newEditorState = _draftJs.EditorState.forceSelection(
            newState,
            newSelection
          );
    ...
    },
    {
      ...
      value: function updateData(data) {
        ...
        var newContentState = _draftJs.Modifier.mergeBlockData(
          content,
          selection,
          data
        );
        var newEditorState = _draftJs.EditorState.push(
          editorState,
          newContentState,
          "change-block-data"
        );
